...
RegisterCommand('firewlsave', function(source, args, rawCommand)
		Whitelist:save()
...
AddEventHandler('fireManager:createFlame', function(fireIndex, coords)
...
AddEventHandler('fireManager:removeFlame', function(fireIndex, flameIndex)
...
TriggerClientEvent('QBCore:Notify', src, 'Your subscribe to fire call!', 'ambulance')
						...
						elseif (Config.Fire.spawner.firefighterJobs) then
							...
							QBCore.Functions.Notify("Your unsubscribe from fire call!", "error")
						end
					end
				end
			end)
